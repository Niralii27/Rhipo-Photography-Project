...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO advertise (image,status, created_at) 
            VALUES ('$image', '$status', NOW())";
...
<div class="content">
					<div class="container-fluid" style="width:200%;">
						<div class="row">
							<div class="col-md-6">
								<div class="card">
                <form id="portfolioform" method="POST" action="add_advertise.php" enctype="multipart/form-data">
...
<script>
  ...
  $('#portfolioform').validate({
    ...
    messages: {
      image: {
        required: "Please enter a Images File.",
      }
