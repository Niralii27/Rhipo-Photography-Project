...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO review (name,title, description, image, created_at) 
            VALUES ('$name','$title', '$description', '$image', NOW())";
...
<div class="content">
					<div class="container-fluid" style="width:200%;">
						<div class="row">
							<div class="col-md-6">
								<div class="card">
                <form id="portfolioform" method="POST" action="add_review.php" enctype="multipart/form-data">

									<div class="card-body">
                                    <div class="form-group">
											<label for="text">Client Name</label>
											<input type="text" class="form-control" id="name" name="name" placeholder="Enter Name Of Client">
										</div>
										<div class="form-group">
											<label for="text">Title</label>
											<input type="text" class="form-control" id="title" name="title" placeholder="Enter Title Of Review">
										</div>
										<div class="form-group">
