...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   // Handle the description field
      ...
      foreach ($description_lines as $line) {
          if (!empty(trim($line))) {
              $description_html .= '<li>' . htmlspecialchars(trim($line), ENT_QUOTES, 'UTF-8') . '</li>';
          }
      }
      $description_html .= '</ul>';
      ...
      $sql = "INSERT INTO booking (title, hours, fees, image, description, created_at) 
              VALUES ('$title', '$hours', '$fees', '$image', '$description_html', NOW())";
...
<div class="content">
					<div class="container-fluid" style="width:200%;">
						<div class="row">
							<div class="col-md-6">
								<div class="card">
                <form id="portfolioform" method="POST" action="add_booking.php" enctype="multipart/form-data">

									<div class="card-body">
                                 
										<div class="form-group">
											<label for="text">Title</label>
											<input type="text" class="form-control" id="title" name="title" placeholder="Enter Title Of Booking">
										</div>
                                        <div class="form-group">
											<label for="text">Hours</label>
											<input type="text" class="form-control" id="hours" name="hours" placeholder="Enter Booking Hours">
										</div>
                                        <div class="form-group">
											<label for="text">Fees</label>
											<input type="text" class="form-control" id="fees" name="fees" placeholder="Enter Booking Fees">
										</div>									

                  <div class="form-group">
                    <label for="description">Description</label>
                    <textarea class="form-control" id="description" name="description" placeholder="Enter Description (one line per bullet point)" rows="5"></textarea>
                  </div>
...
<script>
  ...
  $('#portfolioform').validate({
    ...
    messages: {
      ...
      description: {
        required: "Please enter a description with bullet points.",
      },
    },
